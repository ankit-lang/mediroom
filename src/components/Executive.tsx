                              ...
                              <div className="flex flex-wrap  justify-center gap-4 md:gap-12 md:flex-row flex-col text-center">
                                    {links.map((text, index) => (
                                          <Link
                                                ...
                                                to={text.url}
                                                style={{}}
                                                className=" !text-[20px] md:text-base text-[#ff8706] relative hover:after:content-[''] hover:after:absolute hover:after:left-0 hover:after:bottom-[-2px] hover:after:h-[1px] hover:after:w-full hover:after:bg-orange-600 transition-all duration-300"
                                          >
                                                {text.name}
                                          </Link>
                                    ))}
