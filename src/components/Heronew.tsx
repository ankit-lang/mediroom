...
/>
        ...
        >
          <div
            className="bg-white/95 backdrop-blur-2xl border border-[#F57E5F] rounded-full shadow-2xl p-6 flex flex-col md:flex-row items-center gap-6 max-w-4xl mx-auto transition-all duration-300 hover:shadow-[#F57E5F]/50"
            style={{ boxShadow: '0 12px 40px 0 rgba(31, 38, 135, 0.18)' }}
          >
            <div className="flex-1 flex items-center gap-3 px-4 py-2 rounded-full bg-[#F57E5F]/10 border border-[#F57E5F] focus-within:ring-2 focus-within:ring-[#F57E5F] transition">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#F57E5F]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
              <input
                type="text"
                placeholder="Select a city"
                className="w-full bg-transparent placeholder-[#F57E5F] focus:outline-none text-[#F57E5F]"
                value={city}
                onChange={e => setCity(e.target.value)}
                required
              />
            </div>
            <div className="h-8 border-l border-[#F57E5F] hidden md:block" />
            <div className="flex-1 flex items-center gap-3 px-4 py-2 rounded-full bg-[#F57E5F]/10 border border-[#F57E5F] focus-within:ring-2 focus-within:ring-[#F57E5F] transition">
              <div className="flex items-center gap-1">
                ...
                <input
                  ...
                  className="bg-transparent focus:outline-none text-[#F57E5F]"
                  style={{ width: '110px' }}
                  required
                />
              </div>
              <span className="text-[#F57E5F] font-bold text-lg">→</span>
              <div className="flex items-center gap-1">
                {/* Check-out input */}
                <input
                  type="date"
            ...
            <div className="flex-1 flex items-center gap-3 px-4 py-2 rounded-full bg-[#F57E5F]/10 border border-[#F57E5F] focus-within:ring-2 focus-within:ring-[#F57E5F] transition">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="text-lg text-[#F57E5F] px-3 rounded-full bg-[#F57E5F]/20 hover:bg-[#F57E5F]/30 transition"
                  type="button"
                ...
                <input
                  ...
                  className="w-12 text-center bg-transparent focus:outline-none text-[#F57E5F] font-medium"
                  required
                />
                <button
            ...
            <button
              type="submit"
              className="bg-gradient-to-r from-[#F57E5F] to-[#F57E5F] text-white px-8 py-3 rounded-full ml-auto whitespace-nowrap shadow-lg hover:from-[#F57E5F]/90 hover:to-[#F57E5F]/90 transition-all font-bold tracking-wide"
              disabled={loading}
            >
        ...
        <form onSubmit={handleSubmit} className="block md:hidden realtive z-[1000] bg-[#fff8f5] mt-[-2rem] rounded-t-[5rem] p-3 !text-gray-800 shadow-md space-y-6">
    <h1 className="text-4xl !font-poppins non-italic text-[#F57E5F] text-center font-medium leading-tight">
    ...
    <div className="flex items-center gap-3 border border-gray-300 rounded-full px-4 py-3 bg-white">
        <SearchIcon className="w-5 h-5 text-[#F57E5F]" />
        <input
            type="text"
            placeholder="Select a city"
    ...
    <div className="flex relative items-center text-gray-800 justify-between border border-gray-300 rounded-full px-4 py-3 bg-white text-sm">
        <div className="flex items-center gap-2">
        ...
        <span className="text-[#F57E5F] font-bold">→</span>
        <div>
            <input
                type="date"
                value={checkOut}
    ...
    <button type="submit" className="w-full bg-[#F57E5F] text-white py-3 rounded-full font-medium" disabled={loading}>
        {loading ? 'Booking...' : 'Book'}
    </button>
    {error && <div className="text-red-600 text-sm mt-2">{error}</div>}
    {success && <div className="text-green-600 text-sm mt-2">Booking request sent!</div>}
</form>
