  ...
  return (
    <section id="location" className={`${dir === 'rtl' ? 'rtl' : ''}`}>
      <div className="container mx-auto px-4 md:px-8 py-16">
        ...
        <p className="section-subtitle text-center mb-12">{t.location.subtitle}</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          <div className="bg-beige p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4 text-olive">{t.location.fromAirport.title}</h3>
            <p className="mb-2">{t.location.fromAirport.description}</p>
          ...
          <div className="bg-beige p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4 text-olive">{t.location.publicTransport.title}</h3>
            <p className="mb-2">{t.location.publicTransport.description}</p>
            <ul className="list-disc list-inside text-text-light">
          ...
          <div className="bg-beige p-6 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold mb-4 text-olive">{t.location.parking.title}</h3>
            <p className="mb-2">{t.location.parking.description}</p>
            <ul className="list-disc list-inside text-text-light">
