...
export default function ExperienceHomeSection() {
  ...
  return (
    <section className="py-16 bg-white">
      <div className="container mx-auto text-[#784420] px-6 lg:px-8">
        <h2 className="text-3xl lg:text-4xl font-bold text-center !text-[#784420] mb-4">Experience A Home Away From Home</h2>
          ...
          {highlights.map((item, idx) => (
            <Card key={idx} className="p-6 hover:shadow-lg transition-shadow">
              <div className="flex items-center space-x-4 mb-4">
                {/* Change icon color */}
                {React.cloneElement(item.icon, { className: "w-8 h-8 text-[#784420]" })}
                <h3 className="text-xl text-[#784420] font-semibold">{item.title}</h3>
              </div>
        ...
        <div className="mt-16">
          <h3 className="text-2xl font-semibold mb-4 text-[#784420]">Moydom is ideal for:</h3>
          <ul className="bg-[#e5ddb8] rounded-xl p-6 space-y-3">
            {
              ["Medical tourists seeking proximity to hospitals",
                ...
                <li key={idx} className="flex items-start space-x-3 text-[#784420] text-lg">
                  <svg className="w-5 h-5 mt-1 flex-shrink-0 text-[#784420]" fill="none" stroke="currentColor" strokeWidth="3" viewBox="0 0 24 24">
        ...
        <div className="mt-16 bg-[#784420] p-2 rounded-s-2xl pl-4 text-white">
        ...
        <div className="mt-16  bg-[#784420] p-2 rounded-e-2xl text-white text-center">
