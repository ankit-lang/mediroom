...
export default function WhyMoydomSection() {
  const features = [
    ...
    {
      icon: <HeartHandshake className="w-8 h-8 text-green-800" />, 
  ...
  return (
    <section className="py-16 bg-gray-50">
      <div className="container mx-auto px-6 lg:px-8">
        <h2 className="text-3xl lg:text-4xl font-bold text-center mb-4 text-green-800">Why Moydom is the Preferred Choice</h2>
        <p className="text-center text-lg text-green-800 mb-12">
